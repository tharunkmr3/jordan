...
function NavItem({ item, isActive, collapsed }: { item: typeof nav[0]; isActive: boolean; collapsed: boolean }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "flex items-center gap-3 rounded-md px-3 py-1.5 text-[13px] font-semibold transition-colors",
        ...
        <nav className="flex-1 overflow-y-auto px-2 pt-3">
          ...
          <div className="space-y-0.5">
            ...
            <button
              ...
              className={cn(
                "flex w-full items-center gap-3 rounded-md px-3 py-1.5 text-[13px] font-semibold text-[#525252] hover:bg-[#ebebeb] hover:text-[#2e2e2e] transition-colors",
                collapsed && "justify-center px-0"
              )}
            >
