    ...
    return (
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-[15px] font-semibold text-[#2e2e2e]">Billing</h1>
        </div>
        <Card className="mb-6">
          <CardHeader>
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {(Object.entries(PLANS) as [PlanKey, typeof PLANS[PlanKey]][]).map(([key, plan]) => {
          ...
          return (
            <Card key={key} className={isCurrent ? 'border-[#2e2e2e]' : ''}>
              <CardHeader>
                ...
                <CardDescription className="text-[12px]">
                  <span className="text-[20px] font-semibold text-[#2e2e2e]">
                ...
                <ul className="space-y-2">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-center gap-2 text-[12px] text-[#525252]">
                      <svg className="h-3.5 w-3.5 text-[#2e2e2e] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
